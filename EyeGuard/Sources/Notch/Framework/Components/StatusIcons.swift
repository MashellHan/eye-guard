...
struct WaitingForInputIcon: View {
    ...
    init(size: CGFloat = 12, color: Color = IslandTerminalColors.green) {
        self.size = size
        self.color = color
    }
...
struct WaitingForApprovalIcon: View {
    ...
    init(size: CGFloat = 12, color: Color = IslandTerminalColors.amber) {
        self.size = size
        self.color = color
    }
...
struct RunningIcon: View {
    ...
    init(size: CGFloat = 12, color: Color = IslandTerminalColors.cyan) {
        self.size = size
        self.color = color
    }
...
struct IdleIcon: View {
    ...
    init(size: CGFloat = 12, color: Color = IslandTerminalColors.dim) {
        self.size = size
        self.color = color
    }
