...
@MainActor
class IslandSoundSelector: ObservableObject {
    static let shared = IslandSoundSelector()
    ...
    var expandedPickerHeight: CGFloat {
        ...
        let totalOptions = IslandNotificationSound.allCases.count
