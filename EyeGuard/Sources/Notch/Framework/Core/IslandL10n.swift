...
enum IslandL10n {
    ...
    // MARK: - Sound event display names (for IslandSoundManager)
    ...
    static func approveWhat(_ tool: String) -> String { tr("\(IslandL10n.approve) \(tool)?", "\(IslandL10n.approve) \(tool)?") }
    ...
    // the hand-rolled `IslandL10n` helper (en + zh-Hans as Swift string
