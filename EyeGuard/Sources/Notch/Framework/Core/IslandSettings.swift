...
enum IslandNotificationSound: String, CaseIterable {
    case none = "None"
    case pop = "Pop"
    case ping = "Ping"
    case tink = "Tink"
...
enum IslandAppSettings {
    ...
    static var notificationSound: IslandNotificationSound {
        get {
            guard let rawValue = defaults.string(forKey: Keys.notificationSound),
                  let sound = IslandNotificationSound(rawValue: rawValue) else {
